...
export default function SubscriptionPage({ token, onBack, onLogout }: SubscriptionPageProps) {
  ...
  const plans = [
    {
      ...
      features: [
        ...
        { text: t('proFeatureMaterialWorkbench'), included: false },
    ...
    },
    {
      ...
      features: [
        ...
        { text: t('proFeaturePublishPacks'), included: true },
        { text: t('proFeatureBatch'), included: true },
  ...
  return (
    <div data-testid="subscription-page" className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      {/* Header */}
