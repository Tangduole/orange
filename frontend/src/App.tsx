...
<p className={`text-sm text-slate-500 font-medium whitespace-nowrap overflow-hidden ${(item.title || '').length > 20 ? 'animate-marquee' : 'truncate'}`}>{item.title || t('untitled')}</p>
